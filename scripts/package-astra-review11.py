...
for folder in ['artist','fresh-verified','lifecycle-verified','controller-verified','audio-verified','solo-ui-verified','integrated-ui-final','bay-material-isolation','bay-final','lighting-final','full-art-review-02','baseline-districts-corrected','crew-ui-diagnosis','crew-ui-clock-reproduction','crew-ui-clock-aligned','crew-ui-final-clock-proof','bay-material-repaired-final','bay-material-repaired','live-audio-final-routing','day-verified','video-final']:
 d=b/folder
 if d.exists():
  for p in d.glob('*'):
...
for n in ['complete-race-LIVE-AUDIO.mp4','live-game-audio.webm','grid.png','contest.png','cockpit.png','final-lap.png','result.png','saved-build.png']:add(b/'video-final'/n)
