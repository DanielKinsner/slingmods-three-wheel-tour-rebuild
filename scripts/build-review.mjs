...
const report={commit,created:new Date().toISOString(),command:'node scripts/build-review.mjs (npm run build)',inputs:before,method:'SHA256 snapshot immediately before compile; input equality checked after successful compile. Served bytes checked separately during capture.'};
