...
for n,h in build['inputs'].items():
 ...
 add(n)
for n in ['README.md','AGENTS.md','.gitignore','.gitattributes','director-kit/AGENTS.md','scripts/summarize-review10.py','scripts/package-astra-review10.py','scripts/finalize-review10.py','scripts/check-shared-support.ts','scripts/render-flow-review10.py']:add(n)
...
for n in ['baseline.json','baseline-tests.log','solo-before.json','parity.json','parity-verified.log','support-check.json','preserved-foundation.json','build-inputs-verified.json','build-verified.log','tests-verified.log','milestones.md','reviewer-competition-final.md','reviewer-career-final.md','reviewer-integration-last.md','native-contact-repair.md','failed-native-repeat.json.gz','performance-summary.json','performance-review.md','acceptance-results.json','media-review.json','final-review.md','STATE-EXCERPT.json']:add(b/n)
...
for n in ['run.json','provenance.json','bay.json','reloaded-bay.json','video.json','complete-race-SILENT.mp4']:add(b/'video-verified'/n)
for n in ['grid','contest','cockpit','final-lap','result','returned-bay','saved-build']:add(b/'video-verified'/(n+'.png'))
for n in ['grid','contest','cockpit','final-lap']:add(b/'video-verified'/(n+'.json'))
add(b/'fresh-verified/fresh-chapter.png')
for n in ['flow-video.json','chapter-flow-EDITED-SILENT.mp4']:add(b/'fresh-verified'/n)
