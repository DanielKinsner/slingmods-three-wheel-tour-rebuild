...
export class FinishFirstDriver {
 ...
 readonly plan={pace:58,lateral:7,braking:5.5,headway:.55,line:2.6,initialLane:2.6};
 ...
 sample(t:VehicleTelemetry,field:Record<string,VehicleTelemetry>,dt=1/60){return toDevice(this.controller.control(t,field,dt))}
