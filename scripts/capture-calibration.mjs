...
const dir='director-kit/production/evidence/G0';await mkdir(dir,{recursive:true});
...
await page.goto('http://127.0.0.1:5186');await page.waitForFunction(()=>window.__TWT?.ready);
