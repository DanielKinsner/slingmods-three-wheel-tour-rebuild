...
for directory in sorted(base.glob('verified-scored-*'))+[base/'stock720-followup',base/'heavy1080-followup']:
 ...
 target=interval['p95']<=20.000001 and interval['p99']<=33.400001 and interval['over100']==0
...
for directory in sorted(base.glob('day-scored-*')):
 ...
 racing=[r for r in rows if r[10]==2];interval=stats([r[1] for r in racing]);assert interval
