...
export class EvidenceDriver {private controller:RivalController;constructor(route:CourseRoute,seed=11){this.controller=new RivalController(route,'player',seed,'slingmods-sport-v2')}sample(t:VehicleTelemetry,field:Record<string,VehicleTelemetry>,dt=1/60){return toDevice(this.controller.control(t,field,dt))}inspect(){return this.controller.inspect()}}
