 ...
 */
export type PerfFix='transparency'|'matrix'|'rear'|'rider'|'materials'|'proxy';
export const PERF_FIXES:readonly PerfFix[]=['transparency','matrix','rear','rider','materials','proxy'];
