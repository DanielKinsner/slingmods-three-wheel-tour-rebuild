...
export const speedDressingURLs=(route:'express'|'harbor')=>[...BASIS_TRANSCODER_URLS,...RACE_ASPHALT_URLS,...ROAD_DECAL_URLS,...tracksideAssetURLs(route==='express'?EXPRESS_PROPS:HARBOR_PROPS)];
