...
export const HARBOR_WATER_URLS={swell:P11+'harbor-water/swell-normal.ktx2',chop:P11+'harbor-water/chop-normal.ktx2',foam:P11+'harbor-water/foam.ktx2'} as const;
...
export const speedDressingURLs=(route:'express'|'harbor')=>[...BASIS_TRANSCODER_URLS,...RACE_ASPHALT_URLS,PUDDLE_MASK_URL,...ROAD_DECAL_URLS,...tracksideAssetURLs(route==='express'?EXPRESS_PROPS:HARBOR_PROPS),...(route==='harbor'?Object.values(HARBOR_WATER_URLS):[])];
