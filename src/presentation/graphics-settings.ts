...
export const GRAPHICS_PRESETS:Record<GraphicsQuality,GraphicsPreset>={
 ...
 low:{label:'Low',post:true,samples:0,pixelRatioCap:1,bloomLevels:0,dynamicResolution:true,wetReflections:0,lighting:'low',waterSwell:false,vehicleEffects:.35,headlightFog:false,exhaustShimmer:false},
 medium:{label:'Medium',post:true,samples:2,pixelRatioCap:1,bloomLevels:4,dynamicResolution:true,wetReflections:0,lighting:'standard',waterSwell:true,vehicleEffects:.65,headlightFog:true,exhaustShimmer:false},
 high:{label:'High',post:true,samples:4,pixelRatioCap:1.5,bloomLevels:5,dynamicResolution:true,wetReflections:2,lighting:'standard',waterSwell:true,vehicleEffects:1,headlightFog:true,exhaustShimmer:true},
 ultra:{label:'Ultra',post:true,samples:4,pixelRatioCap:2,bloomLevels:6,dynamicResolution:false,wetReflections:1,lighting:'standard',waterSwell:true,vehicleEffects:1.3,headlightFog:true,exhaustShimmer:true}};
