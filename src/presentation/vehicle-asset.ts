...
export const CURRENT_VEHICLE=VEHICLE_VISUAL==='ryker'?'ryker-900.glb':VEHICLE_VISUAL==='2026'?'slingshot-2026.glb':VEHICLE_VISUAL==='josh'?'slingshot-josh-adapted.glb':'slingshot-hoops-refined.glb';
...
export const CURRENT_VEHICLE_URL=VEHICLE_VISUAL==='ryker'?'/assets/ryker/ryker-900.glb':VEHICLE_VISUAL==='2026'?MODEL_2026_URL:VEHICLE_VISUAL==='josh'?JOSH_VEHICLE_URL:LEGACY_VEHICLE_URL;
