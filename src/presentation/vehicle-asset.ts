...
export const VEHICLE_MODEL_LABEL=VEHICLE_VISUAL==='2026'?'2026 Slingshot R':'2024 Slingshot R';
export const PRODUCT_FITMENT_LABEL=VEHICLE_VISUAL==='2026'?'2026 game mount · retail fitment unverified':'Fits 2024 Slingshot R';
