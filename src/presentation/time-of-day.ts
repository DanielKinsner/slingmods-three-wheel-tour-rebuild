 ...
 */
export type TimeOfDay='day'|'golden-hour'|'dusk'|'night'|'after-rain';
...
export const LOOKS:Record<TimeOfDay,Look>={
 ...
 'after-rain':{id:'after-rain',label:'After rain',base:'day',sky:SKIES+'after-rain-2k.hdr',skyGain:1.0,environment:.9,exposure:.92,sun:{color:'#fff1de',intensity:1.5},hemisphere:{sky:'#c4d2e0',ground:'#6d6f70',intensity:.42},fog:{color:'#aebcc8',near:300,far:1200},lampsOn:false,bloom:{threshold:1.2,intensity:.65},grade:{tint:[.97,1,1.04],saturation:.96,contrast:1.05},wet:true}};
export const LOOK_ORDER:readonly TimeOfDay[]=['day','golden-hour','dusk','night','after-rain'];
...
export const DEFAULT_LOOK:Record<'express'|'harbor',TimeOfDay>={express:'dusk',harbor:'dusk'};
