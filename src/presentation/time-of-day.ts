...
export const LOOKS={
 day:{id:'day',label:'Day',base:'day',sky:null,skyGain:1,environment:.95,exposure:.95,sun:null,hemisphere:null,fog:null,lampsOn:false,bloom:{threshold:1.6,intensity:.32},grade:NEUTRAL,wet:false},
 'golden-hour':{id:'golden-hour',label:'Golden hour',base:'day',sky:SKIES+'golden-hour-2k.hdr',skyGain:.85,environment:.85,exposure:.98,sun:{color:'#ffb066',intensity:2.6},hemisphere:{sky:'#ffd9b0',ground:'#6b5a4c',intensity:.34},fog:{color:'#e8c9a4',near:260,far:1300},lampsOn:false,bloom:{threshold:1.45,intensity:.4},grade:{tint:[1.06,.99,.9],saturation:1.08,contrast:1.06},wet:false},
 dusk:{id:'dusk',label:'Dusk',base:'night',sky:SKIES+'dusk-2k.hdr',skyGain:.5,environment:.5,exposure:1.0,sun:{color:'#ff9a6a',intensity:.55},hemisphere:{sky:'#8fa3c8',ground:'#3a3340',intensity:.5},fog:{color:'#6f7896',near:220,far:1100},lampsOn:true,bloom:{threshold:1.1,intensity:.5},grade:{tint:[.98,.94,1.1],saturation:1.1,contrast:1.1},wet:false},
 night:{id:'night',label:'Night',base:'night',sky:null,skyGain:1,environment:1,exposure:1.05,sun:null,hemisphere:null,fog:null,lampsOn:true,bloom:{threshold:1.05,intensity:.5},grade:NEUTRAL,wet:false},
 'after-rain':{id:'after-rain',label:'After rain',base:'day',sky:SKIES+'after-rain-2k.hdr',skyGain:1.0,environment:.9,exposure:.92,sun:{color:'#fff1de',intensity:1.5},hemisphere:{sky:'#c4d2e0',ground:'#6d6f70',intensity:.42},fog:{color:'#aebcc8',near:300,far:1200},lampsOn:false,bloom:{threshold:1.8,intensity:.25},grade:{tint:[.97,1,1.04],saturation:.96,contrast:1.05},wet:true}} as Record<TimeOfDay,Look>;
// The wet variants are the same light with a wet road. Wet is visual only: grip, physics and records never change.
LOOKS['dusk-rain']={...LOOKS.dusk,id:'dusk-rain',label:'Dusk, after rain',wet:true,bloom:{threshold:1.05,intensity:.55}};LOOKS['night-rain']={...LOOKS.night,id:'night-rain',label:'Night, after rain',wet:true,bloom:{threshold:1.0,intensity:.55}};
