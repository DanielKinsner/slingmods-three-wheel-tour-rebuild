...
export interface BuildRecipe {version:1;vehicleId:'slingshot-r-2024';finish:FinishId;products:Partial<Record<ProductId,string>>;lights:Appearance;suspension:SuspensionSetup;handlingProfile:'slingmods-sport-v1'|'slingmods-sport-v2'|'slingmods-sport-v3'|'slingmods-sport-v4'}
...
export const driveTuneLabel=(id:BuildRecipe['handlingProfile'])=>id===CURRENT_HANDLING_PROFILE?'Sport v4 · forgiving':id==='slingmods-sport-v3'?'Sport v3 · historical':id==='slingmods-sport-v2'?'Sport v2 · historical':'Sport v1 · historical';
