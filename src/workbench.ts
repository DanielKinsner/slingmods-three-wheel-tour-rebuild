...
document.querySelector('#stage')!.textContent=(proof?'P03A2 / LOCAL PROOF':bay?(fidelity?(vehicleFile==='slingshot-p03a2.glb'?'P03A2 / INSPECTION':'P03A1 / INSPECTION'):'P03A / INSPECTION'):driving?'P03B2 / FIRST DRIVE':'NEUTRAL / INSPECTION')+' · '+__BUILD_REF__;
