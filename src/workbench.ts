...
if(bay){
 const soloEntry=mountHarborEntry();soloEntry.hidden=true;const button=document.createElement('button');button.id='open-build';button.textContent='Build · Make it yours';document.querySelector('#app')!.append(button);
