...
const normalLights=new Map<THREE.Light,number>();scene.traverse(o=>{if(o instanceof THREE.Light)normalLights.set(o,o.intensity)});const normalEnvironment=scene.environmentIntensity;
function fitBuild(){
