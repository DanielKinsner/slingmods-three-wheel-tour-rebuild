...
export type HandlingProfileId='legacy-p08a'|'slingmods-sport-v1'|'slingmods-sport-v2'|'slingmods-sport-v3'|'slingmods-sport-v4'|'slingmods-sport-v5'|'ryker-road-v1'|'spyder-f3-v1';
...
export const HANDLING_PROFILES={
 ...
 // V4: same steering/power/grip envelope; bounded game-only stability in Simulation.
 'slingmods-sport-v4':{id:'slingmods-sport-v4',name:'SlingMods Sport v4 forgiving',torqueScale:1.30,shiftSeconds:.18,steerLock:.60,steerFalloff:.021,lateralSteerLimit:8.2,steerRate:2.7,asphaltGripScale:1.15,tireStiffness:8,brakeScale:1,brakeSteerRelief:0,damperFront:3800,damperRear:6500},
 // V5 retains v4 stability and finite grip, with more high-speed steering reserve.
 'slingmods-sport-v5':{id:'slingmods-sport-v5',name:'SlingMods Sport v5 responsive',torqueScale:1.30,shiftSeconds:.18,steerLock:.60,steerFalloff:.021,lateralSteerLimit:8.2,steerRate:2.7,asphaltGripScale:1.15,tireStiffness:8,brakeScale:1,brakeSteerRelief:0,damperFront:3800,damperRear:6500},
} as const;
...
export function steeringLimit(speed:number,id:HandlingProfileId='legacy-p08a',wheelbase=2.667){const p=handlingProfile(id);const geometric=Math.atan(p.lateralSteerLimit*wheelbase/Math.max(speed*speed,1));
 ...
 const reserve=(id==='ryker-road-v1'||id==='spyder-f3-v1')?.045*speed*speed/(speed*speed+144):id==='slingmods-sport-v5'?.035*speed*speed/(speed*speed+225):(id==='slingmods-sport-v3'||id==='slingmods-sport-v4')?.025*speed*speed/(speed*speed+100)/(1+speed*speed/500):0;
