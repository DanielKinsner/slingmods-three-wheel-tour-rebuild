...
export type VehicleId='slingshot-r-2024'|'can-am-ryker-900';
export interface VehicleDefinition {
 readonly id:VehicleId;readonly revision:string;readonly powertrain:'five-speed'|'cvt';
