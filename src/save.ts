...
export interface Save { version:1; vehicleId:'slingshot-r-2024'; settings:{camera:'near'|'far'|'cockpit';mute:boolean;volume:number;interfaceVolume:number;engineVolume:number};records:Record<string,LapRecord> }
export const freshSave = ():Save => ({version:1,vehicleId:'slingshot-r-2024',settings:{camera:'near',mute:false,volume:.55,interfaceVolume:1,engineVolume:1},records:{}});
