...
for s,label in [(-1,'left'),(1,'right')]:
 ...
 for j in range(len(stations)-1):
  for k in range(2):i=j*3+k; f.append((i,i+1,i+4,i+3))
...
panel('center_headlamp_pod',[(-.20,2.082,.55),(.20,2.082,.55),(.18,1.96,.638),(-.18,1.96,.638)],inset)
panel('lights_head_center',[(-.16,2.086,.57),(.16,2.086,.57),(.15,2.03,.615),(-.15,2.03,.615)],lens)
path('front_splitter',[(-.965,1.965,.172),(-.72,2.065,.144),(-.39,2.12,.144),(-.22,2.12,.217),(.22,2.12,.217),(.39,2.12,.144),(.72,2.065,.144),(.965,1.965,.172)],.018,dark)
panel('hood_scoop',[(-.125,.89,.814),(.125,.89,.814),(.145,1.02,.81),(-.145,1.02,.81)],inset)
for s in (-1,1):
